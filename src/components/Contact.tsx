...
const links = [
  {
    ...
    href: "mailto:hello@example.com?subject=Project%20Inquiry&body=Hi%2C%20I'd%20love%20to%20discuss%20a%20project.",
    icon: (
      ...
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        >
          ...
          <p className="text-gray-400 text-base md:text-lg max-w-xl mx-auto mb-10 leading-relaxed">
            Have a project in mind? Let&apos;s talk. Free consultation — no strings attached.
          </p>
        </motion.div>
