  ...
  return (
    <motion.header
      ...
      className={cn(
        ...
        scrolled
          ? "bg-black/60 backdrop-blur-md md:backdrop-blur-xl border-b border-white/[0.04]"
          : "bg-transparent"
      )}
    >
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="md:hidden bg-black/80 backdrop-blur-lg md:backdrop-blur-2xl border-b border-white/[0.04] overflow-hidden safe-bottom"
          >
